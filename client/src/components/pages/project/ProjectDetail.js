              ...
              {project && project.id && project.issuer && (
                <div>
                  ...
                  {project &&
                    ...
                    project.fulfiller !== null &&
                    drizzle.web3.utils
                      .toBN(project.fulfiller)
                      .toString() !== '0' && (
                      <div className="col s12 m12 l5 xl5">
                        <div
                          style={{ marginTop: '20px' }}
            ...
            {project.ratingsIssuerDone === true && (
              <div className="col s12 m12 l6 xl6">
                <h5>
                  ...
                  {_.mean(
                    Array.from(project.ratingsIssuer, value =>
                      Number(value),
                    ),
                  ).toFixed(1)}{' '}
                  / 5
            ...
            {project.ratingsFulfillerDone === true && (
              <div className="col s12 m12 l6 xl6">
                <h5>
                  ...
                  {_.mean(
                    Array.from(project.ratingsFulfiller, value =>
                      Number(value),
                    ),
                  ).toFixed(1)}{' '}
                  / 5
                ...
                <div className="row">
                  <div className="col">
                    <p>
                      The delivery reached the expected level of
                      quality:
                    </p>
